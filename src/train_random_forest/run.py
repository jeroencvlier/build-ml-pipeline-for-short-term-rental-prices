...
def go(args):
    ...
    ######################################
    logger.info(f"Loading trainval dataset from {trainval_local_path}")
    ...
    model_export_artifact = wandb.Artifact(
        args.output_artifact, type="model_export", description="Random Forest model export", metadata=rf_config)
